...
import javax.swing.*;
import Employee_Module.AdminScreen;
...
import benefitsBox.ViewReimb;

import java.sql.*;


public class HomePageAdmin extends JFrame implements ActionListener{
...
static int empid;
	...
	public HomePageAdmin(String s1) {
...
//		JMenuItem ment4 = new JMenuItem("Delete Profile");
		...
		JMenuItem ment11= new JMenuItem("Clain for Medical Facilities");
...
//		ment4.addActionListener(this);
        ...
        JLabel label=new JLabel("This is "+s1+" Page");
