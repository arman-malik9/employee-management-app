		...
		c1.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent arg0)
			{
				try
				{
					...
					String q2="select * from employeeData where Empid='"+eid+"'";
					ResultSet rest1=obj2.stm.executeQuery(q2);
					while(rest1.next())
					{
						tf1.setText(rest1.getString("EmpFirstName")+" "+rest1.getString("EmpLastName"));
